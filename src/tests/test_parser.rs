use crate::parser;
use crate::ast::{Statement, AstNode, FunctionPrototype, FunctionArgument, BasicDataType, DataType, Function, Expression, BinaryExpression, BinaryOperator};
use crate::error::FTLError;
use crate::position_container::{PositionRangeContainer, PositionRange};
use crate::ast::DataType::Basic;
use crate::ast::BinaryOperator::Add;
...
fn parse_binary_operation() {
    ...
    let expected: [Result<AstNode, FTLError>; 1] = [Ok(
        AstNode::Statement(
            Statement::Function(
                Function {
